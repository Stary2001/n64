//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (--------) on 2021-06-04 18:47:05
//--------------------------------------------------------------------------------
...
reg litedramcore_bankmachine0_trccon_ready = 1'd1;
wire litedramcore_bankmachine0_trascon_valid;
reg litedramcore_bankmachine0_trascon_ready = 1'd1;
...
reg litedramcore_bankmachine1_trccon_ready = 1'd1;
wire litedramcore_bankmachine1_trascon_valid;
reg litedramcore_bankmachine1_trascon_ready = 1'd1;
...
reg litedramcore_bankmachine2_trccon_ready = 1'd1;
wire litedramcore_bankmachine2_trascon_valid;
reg litedramcore_bankmachine2_trascon_ready = 1'd1;
...
reg litedramcore_bankmachine3_trccon_ready = 1'd1;
wire litedramcore_bankmachine3_trascon_valid;
reg litedramcore_bankmachine3_trascon_ready = 1'd1;
...
reg litedramcore_trrdcon_ready = 1'd1;
...
assign roundrobin0_request = {(((user_port_cmd_payload_addr[11:10] == 1'd0) & (~(((locked0 | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid)};
...
assign roundrobin1_request = {(((user_port_cmd_payload_addr[11:10] == 1'd1) & (~(((locked1 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid)};
...
assign roundrobin2_request = {(((user_port_cmd_payload_addr[11:10] == 2'd2) & (~(((locked2 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid)};
...
assign roundrobin3_request = {(((user_port_cmd_payload_addr[11:10] == 2'd3) & (~(((locked3 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))))) & user_port_cmd_valid)};
...
assign user_port_cmd_ready = ((((1'd0 | (((roundrobin0_grant == 1'd0) & ((user_port_cmd_payload_addr[11:10] == 1'd0) & (~(((locked0 | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0)))))) & litedramcore_interface_bank0_ready)) | (((roundrobin1_grant == 1'd0) & ((user_port_cmd_payload_addr[11:10] == 1'd1) & (~(((locked1 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0)))))) & litedramcore_interface_bank1_ready)) | (((roundrobin2_grant == 1'd0) & ((user_port_cmd_payload_addr[11:10] == 2'd2) & (~(((locked2 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0)))))) & litedramcore_interface_bank2_ready)) | (((roundrobin3_grant == 1'd0) & ((user_port_cmd_payload_addr[11:10] == 2'd3) & (~(((locked3 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0)))))) & litedramcore_interface_bank3_ready));
assign user_port_wdata_ready = new_master_wdata_ready;
assign user_port_rdata_valid = new_master_rdata_valid3;
...
assign csrbank1_dfii_pi0_wrdata1_w = litedramcore_wrdata_storage[15:8];
assign csrbank1_dfii_pi0_wrdata0_w = litedramcore_wrdata_storage[7:0];
assign csrbank1_dfii_pi0_rddata1_w = litedramcore_rddata_status[15:8];
assign csrbank1_dfii_pi0_rddata0_w = litedramcore_rddata_status[7:0];
assign litedramcore_rddata_we = csrbank1_dfii_pi0_rddata0_we;
...
always @(*) begin
	...
	case (roundrobin0_grant)
		default: begin
			rhs_array_muxed14 <= (((user_port_cmd_payload_addr[11:10] == 1'd0) & (~(((locked0 | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid);
		end
	endcase
// synthesis translate_off
	dummy_d_170 = dummy_s;
...
always @(*) begin
	...
	case (roundrobin1_grant)
		default: begin
			rhs_array_muxed17 <= (((user_port_cmd_payload_addr[11:10] == 1'd1) & (~(((locked1 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid);
		end
	endcase
// synthesis translate_off
	dummy_d_173 = dummy_s;
...
always @(*) begin
	...
	case (roundrobin2_grant)
		default: begin
			rhs_array_muxed20 <= (((user_port_cmd_payload_addr[11:10] == 2'd2) & (~(((locked2 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))))) & user_port_cmd_valid);
		end
	endcase
// synthesis translate_off
	dummy_d_176 = dummy_s;
...
always @(*) begin
	...
	case (roundrobin3_grant)
		default: begin
			rhs_array_muxed23 <= (((user_port_cmd_payload_addr[11:10] == 2'd3) & (~(((locked3 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))))) & user_port_cmd_valid);
		end
	endcase
// synthesis translate_off
	dummy_d_179 = dummy_s;
...
always @(posedge sys_clk) begin
	ddrphy_rddata_en <= {ddrphy_rddata_en, ddrphy_dfi_p0_rddata_en};
	ddrphy_dfi_p0_rddata_valid <= ddrphy_rddata_en[2];
	...
	new_master_wdata_ready <= ((((1'd0 | ((roundrobin0_grant == 1'd0) & litedramcore_interface_bank0_wdata_ready)) | ((roundrobin1_grant == 1'd0) & litedramcore_interface_bank1_wdata_ready)) | ((roundrobin2_grant == 1'd0) & litedramcore_interface_bank2_wdata_ready)) | ((roundrobin3_grant == 1'd0) & litedramcore_interface_bank3_wdata_ready));
	...
	if (csrbank1_dfii_pi0_wrdata1_re) begin
		litedramcore_wrdata_storage[15:8] <= csrbank1_dfii_pi0_wrdata1_r;
	end
	...
	litedramcore_rddata_re <= csrbank1_dfii_pi0_rddata0_re;
	if (sys_rst) begin
		ddrphy_dfi_p0_rddata_valid <= 1'd0;
		ddrphy_rddata_en <= 3'd0;
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[0]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[1]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[2]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[3]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[4]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[5]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[6]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[7]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[8]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[9]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[10]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[11]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0(ddrphy_dfi_p0_address[12]),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.D_OUT_0(ddrphy_dfi_p0_wrdata[0]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[0]),
	.D_IN_0(ddrphy_dfi_p0_rddata[0])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_21 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[1]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[1]),
	.D_IN_0(ddrphy_dfi_p0_rddata[1])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_22 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[2]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[2]),
	.D_IN_0(ddrphy_dfi_p0_rddata[2])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_23 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[3]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[3]),
	.D_IN_0(ddrphy_dfi_p0_rddata[3])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_24 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[4]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[4]),
	.D_IN_0(ddrphy_dfi_p0_rddata[4])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_25 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[5]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[5]),
	.D_IN_0(ddrphy_dfi_p0_rddata[5])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_26 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[6]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[6]),
	.D_IN_0(ddrphy_dfi_p0_rddata[6])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_27 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[7]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[7]),
	.D_IN_0(ddrphy_dfi_p0_rddata[7])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_28 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[8]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[8]),
	.D_IN_0(ddrphy_dfi_p0_rddata[8])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_29 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[9]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[9]),
	.D_IN_0(ddrphy_dfi_p0_rddata[9])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_30 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[10]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[10]),
	.D_IN_0(ddrphy_dfi_p0_rddata[10])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_31 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[11]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[11]),
	.D_IN_0(ddrphy_dfi_p0_rddata[11])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_32 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[12]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[12]),
	.D_IN_0(ddrphy_dfi_p0_rddata[12])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_33 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[13]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[13]),
	.D_IN_0(ddrphy_dfi_p0_rddata[13])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_34 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[14]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[14]),
	.D_IN_0(ddrphy_dfi_p0_rddata[14])
);

SB_IO #(
	.PIN_TYPE(6'd52)
) SB_IO_35 (
	.D_OUT_0(ddrphy_dfi_p0_wrdata[15]),
	.INPUT_CLK(sys_clk),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(ddrphy_dfi_p0_wrdata_en),
	.PACKAGE_PIN(sdram_dq[15]),
	.D_IN_0(ddrphy_dfi_p0_rddata[15])
);
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0((ddrphy_dfi_p0_wrdata_en & ddrphy_dfi_p0_wrdata_mask[0])),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
...
SB_IO #(
	...
	.CLOCK_ENABLE(1'd1),
	.D_OUT_0((ddrphy_dfi_p0_wrdata_en & ddrphy_dfi_p0_wrdata_mask[1])),
	.OUTPUT_CLK(sys_clk),
	.OUTPUT_ENABLE(1'd1),
