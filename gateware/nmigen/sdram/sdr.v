    ...
    always @ (posedge Sys_clk) begin
        ...
        if (Prech_enable == 1'b1) begin
            ...
            if ((Addr[10] === 1'b1 || (Addr[10] === 1'b0 && Ba === 2'b00)) && Act_b0 === 1'b1) begin
                ...
                $display ("%m : at time %t PRECHARGE  : Precharge Bank 0",$time);
            ...
            if ((Addr[10] === 1'b1 || (Addr[10] === 1'b0 && Ba === 2'b01)) && Act_b1 === 1'b1) begin
                ...
                $display ("%m : at time %t PRECHARGE  : Precharge Bank 1",$time);
            ...
            if ((Addr[10] === 1'b1 || (Addr[10] === 1'b0 && Ba === 2'b10)) && Act_b2 === 1'b1) begin
                ...
                $display ("%m : at time %t PRECHARGE  : Precharge Bank 2",$time);
            ...
            if ((Addr[10] === 1'b1 || (Addr[10] === 1'b0 && Ba === 2'b11)) && Act_b3 === 1'b1) begin
                ...
                $display ("%m : at time %t PRECHARGE  : Precharge Bank 3",$time);
